...
def connect_mqtt() -> mqtt_client:
    ...
    def on_connect2(client2, userdata, flags, rc2):
        if rc2 == 0:
            print('Connected to MQTT Broker!')
        else:
            print('Failed to connect, return code %d\n', rc2)
    ...
    client.on_connect2 = on_connect2
...
def subscribe(client: mqtt_client, qos=0):
    data = []
    data2 = []
    print(data)
    print(data2)
    ...
    def on_message(client, userdata, msg):
        data.append(json.loads(msg.payload.decode())) # Criar para o data2? Onde? Preciso diferenciar qual lista para dar o append
        print(data)
        if len(data) == 4:
    ...
    client.subscribe([('/api/adminene03', 1), ('/api/adminene01', 2)])
    client.on_message = on_message
    #client2.subscribe(topic2)
    #client2.on_message2 = on_message2
